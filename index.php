	...
	<?php
		if(array_key_exists('submit', $_POST)) {
			if($_POST["a"] == "W" && $_POST["b"] == "U" && $_POST["c"] == "R" && $_POST["d"] == "D" && $_POST["e"] == "E" && $_POST["f"] == "N"
			 && $_POST["g"] == "A" && $_POST["h"] == "N"
			 && $_POST["i"] == "D" && $_POST["j"] == "I" && $_POST["k"] == "E" && $_POST["l"] == "S" && $_POST["m"] == "E" && $_POST["n"] == "M"
			 && $_POST["o"] == "T" && $_POST["p"] == "A" && $_POST["q"] == "G"
			 && $_POST["r"] == "I" && $_POST["s"] == "N"
			 && $_POST["t"] == "D" && $_POST["u"] == "I" && $_POST["v"] == "E"
			 && $_POST["w"] == "G" && $_POST["x"] == "E" && $_POST["y"] == "M" && $_POST["z"] == "E" && $_POST["aa"] == "I" && $_POST["ab"] == "N" && $_POST["ac"] == "D" && $_POST["ad"] == "E"
			 && $_POST["ae"] == "A" && $_POST["af"] == "U" && $_POST["ag"] == "F" && $_POST["ah"] == "G" && $_POST["ai"] == "E" && $_POST["aj"] == "N" && $_POST["ak"] == "O" && $_POST["al"] == "M" && $_POST["am"] == "M" && $_POST["an"] == "E" && $_POST["ao"] == "N") {
				echo "
				<script type=\"text/javascript\" language=\"Javascript\">
					alert(\"Super! Du hast alles richtig gelöst.\");
				</script>";
			} else {
				echo "
				<script type=\"text/javascript\" language=\"Javascript\">
